...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.getById = function (userId) {
        console.log('url');
        console.log(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/users/" + userId);
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/users/" + userId);
    };
    ...
    UserService.prototype.update = function (user) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/read.php?view=update", user);
    };
    UserService.prototype.delete = function (userId) {
        return this.http.delete(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl + "/users/" + userId);
    };
...
/* harmony import */ var _osulogin_osulogin_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./osulogin/osulogin.component */ "./src/app/osulogin/osulogin.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _osulogin_osulogin_component__WEBPACK_IMPORTED_MODULE_13__["OsuloginComponent"],
...
/* harmony import */ var _osulogin__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./osulogin */ "./src/app/osulogin/index.ts");
/* harmony import */ var _profile__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./profile */ "./src/app/profile/index.ts");
...
var appRoutes = [
    ...
    { path: 'osulogin', component: _osulogin__WEBPACK_IMPORTED_MODULE_5__["OsuloginComponent"] },
    { path: 'profile', component: _profile__WEBPACK_IMPORTED_MODULE_6__["ProfileComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_4__["AuthGuard"]] },
...
module.exports = "\n<h1>Home Page</h1>\n<p>You're logged in with beaver rider</p>\n\n<p *ngIf=\"currentUser\">{{currentUser.userId}}  {{currentUser.email}}  {{currentUser.firstname}}  {{currentUser.lastname}}</p>\n<a (click)=\"userLogout()\" class=\"text-primary\">logout</a>\n\n\n<!--\n<h3>All registered users:</h3>\n\n\n<ul>\n    <li *ngFor=\"let user of users\">\n        {{user.username}} ({{user.firstName}} {{user.lastName}})\n        - <a (click)=\"deleteUser(user.id)\" class=\"text-danger\">Delete</a>\n    </li>\n</ul>\n\n<p><a [routerLink]=\"['/login']\">Logout</a></p>\n\n-->\n\n\n<!--\n<a [routerLink]=\"['/osulogin']\">\n    <button type=\"button\" class=\"btn btn-primary btn-lg\">OSU Login</button>\n</a>\n\n<br><br>\n\n<a [routerLink]=\"['/register']\">\n    <button type=\"button\" class=\"btn btn-primary btn-lg\">Register</button>\n</a>\n-->\n\n\n<br><br>\n\n<a [routerLink]=\"['/profile']\">\n    <button type=\"button\" class=\"btn btn-primary btn-lg\">Profile</button>\n</a>"
...
var HomeComponent = /** @class */ (function () {
    ...
    */
    HomeComponent.prototype.getUserbyuserId = function (userId) {
        var _this = this;
        this.userService.getById(this.currentUserId).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["first"])()).subscribe(function (user) {
            ...
            console.log(_this.currentUser);
            if (_this.currentUser.finishRegister == 0) {
    ...
    */
    HomeComponent.prototype.userLogout = function () {
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services__WEBPACK_IMPORTED_MODULE_3__["UserService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], HomeComponent);
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.getQueryVariable = function (variable) {
    ...
    LoginComponent.prototype.getxml = function () {
        var _this = this;
        this.http.get(this.xmlurl, { responseType: 'text' })
            .subscribe(function (data) { return _this.xmlDoc = data; });
    };
...
/***/ "./src/app/osulogin/index.ts":
/*!***********************************!*\
  !*** ./src/app/osulogin/index.ts ***!
  \***********************************/
/*! exports provided: OsuloginComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _osulogin_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./osulogin.component */ "./src/app/osulogin/osulogin.component.ts");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "OsuloginComponent", function() { return _osulogin_component__WEBPACK_IMPORTED_MODULE_0__["OsuloginComponent"]; });
...
/***/ "./src/app/osulogin/osulogin.component.css":
/*!*************************************************!*\
  !*** ./src/app/osulogin/osulogin.component.css ***!
  \*************************************************/
/*! no static exports found */
...
/***/ "./src/app/osulogin/osulogin.component.html":
/*!**************************************************!*\
  !*** ./src/app/osulogin/osulogin.component.html ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "\n<a href=\"https://login.oregonstate.edu/idp/profile/cas/login?service=http://web.engr.oregonstate.edu/~hezhi/test/login\">\n    <button type=\"button\" class=\"btn btn-primary btn-lg\">Login</button>\n</a>\n\n<!--\"https://login.oregonstate.edu/idp/profile/cas/login?service=http://web.engr.oregonstate.edu/~hezhi/test/login\"-->\n"

/***/ }),

/***/ "./src/app/osulogin/osulogin.component.ts":
/*!************************************************!*\
  !*** ./src/app/osulogin/osulogin.component.ts ***!
  \************************************************/
/*! exports provided: OsuloginComponent */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OsuloginComponent", function() { return OsuloginComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var OsuloginComponent = /** @class */ (function () {
    function OsuloginComponent() {
    }
    OsuloginComponent.prototype.ngOnInit = function () {
    };
    OsuloginComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            template: __webpack_require__(/*! ./osulogin.component.html */ "./src/app/osulogin/osulogin.component.html"),
            styles: [__webpack_require__(/*! ./osulogin.component.css */ "./src/app/osulogin/osulogin.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], OsuloginComponent);
    return OsuloginComponent;
}());
...
module.exports = "<h2>Profile</h2>\n<form [formGroup]=\"profileForm\" (ngSubmit)=\"onSubmit()\">\n\n    <!--\n        <p *ngIf=\"currentUser\">{{currentUser.userId}}</p><p *ngIf=\"currentUser\">{{currentUser.email}}</p><p *ngIf=\"currentUser\">{{currentUser.firstname}}</p><p *ngIf=\"currentUser\">{{currentUser.lastname}}</p>\n    -->\n\n    <div class=\"form-group\">\n        <label for=\"userId\">userId</label>\n        <input type=\"text\" formControlName=\"userId\" readonly=\"readonly\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.userId.errors }\" />\n    </div>\n\n    <div class=\"form-group\">\n        <label for=\"firstname\">First Name</label>\n        <input type=\"text\" formControlName=\"firstname\" readonly=\"readonly\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.firstname.errors }\" />\n    </div>\n\n    <div class=\"form-group\">\n        <label for=\"lastname\">Last Name</label>\n        <input type=\"text\" formControlName=\"lastname\" readonly=\"readonly\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.lastname.errors }\" />\n    </div>\n\n    <div class=\"form-group\">\n        <label for=\"email\">Email</label>\n        <input type=\"text\" formControlName=\"email\" readonly=\"readonly\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.email.errors }\" />\n    </div>\n\n    <div class=\"form-group\">\n        <label for=\"phoneNumber\">Phone Number</label>\n        <input type=\"text\" formControlName=\"phoneNumber\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.phoneNumber.errors }\" />\n        <div *ngIf=\"submitted && f.phoneNumber.errors\" class=\"invalid-feedback\">\n            <div *ngIf=\"f.phoneNumber.errors.required\">Phone Number is required</div>\n        </div>\n    </div>\n\n\n    <div class=\"form-group\">\n        <label for=\"address\">Address</label>\n        <input type=\"text\" formControlName=\"address\" class=\"form-control\" [ngClass]=\"{ 'is-invalid': submitted && f.address.errors }\" />\n        <div *ngIf=\"submitted && f.address.errors\" class=\"invalid-feedback\">\n            <div *ngIf=\"f.address.errors.required\">Address is required</div>\n        </div>\n    </div>\n\n    <div class=\"form-group\">\n        <button [disabled]=\"loading\" class=\"btn btn-primary\">Submit</button>\n        <img *ngIf=\"loading\" src=\"data:image/gif;base64,\" />\n        <a *ngIf=\"currentUser.finishRegister == 1\" [routerLink]=\"['']\" class=\"btn btn-link\">Cancel</a>\n    </div>\n\n</form>\n"
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(formBuilder, router, userService, alertService) {
    ...
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.profileForm = this.formBuilder.group({
            userId: [this.currentUser.userId, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            ...
            phoneNumber: [this.currentUser.phoneNumber, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            email: [this.currentUser.email, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            address: [this.currentUser.address, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    ProfileComponent.prototype.onSubmit = function () {
        ...
        this.userService.update(this.profileForm.value)
            ...
            _this.alertService.success('Update profile successful', true);
...
module.exports = __webpack_require__(/*! /Users/chenkun/Downloads/BeaverRider/src/main.ts */"./src/main.ts");
